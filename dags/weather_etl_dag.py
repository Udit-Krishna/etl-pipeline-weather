...
with DAG(
    ...
    extract_chennai_weather_data_through_api = HttpOperator(
    ...
    extract_mumbai_weather_data_through_api = HttpOperator(
    ...
    extract_bengaluru_weather_data_through_api = HttpOperator(
    ...
    extract_hyderabad_weather_data_through_api = HttpOperator(
    ...
    extract_delhi_weather_data_through_api = HttpOperator(
    ...
    extract_kolkata_weather_data_through_api = HttpOperator(
